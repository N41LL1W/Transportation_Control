...
############### Label Cima ###############
app_nome = Label(frame_cima, text='Informações da Viagem', anchor=NW, font=('Ivy 13 bold'), bg=cor2, fg=cor1, relief='flat')
...
e_data = DateEntry(frame_meio, width=12, background='darkblue', foreground='white', borderwidth=2, year=2022, locale='pt_BR')
e_data.place(x=15, y=30)
# Estado
l_calculo = Label(frame_meio, text='Tabela de calculo *', anchor=NW, font=('Ivy 10 bold'), bg=cor10, fg=cor4, relief='flat')
...
# Km Final
l_email = Label(frame_meio, text='Km Final *', anchor=NW, font=('Ivy 10 bold'), bg=cor10, fg=cor4, relief='flat')
l_email.place(x=10, y=105)
e_email = Entry(frame_meio, width=45, justify='left', relief='solid')
e_email.place(x=15, y=130)
# Km Morto
...
# Peso
l_km_r = Label(frame_meio, text='Peso * - KG', anchor=NW, font=('Ivy 10 bold'), bg=cor10, fg=cor4, relief='flat')
l_km_r.place(x=10, y=255)
e_km_r = Entry(frame_meio, width=14, justify='left', relief='solid')
e_km_r.place(x=15, y=280)
# Km Ent/Col
...
# Manutenção
l_km_i = Label(frame_baixo, text='Manutenção', anchor=NW, font=('Ivy 10 bold'), bg=cor7, fg=cor4, relief='flat')
l_km_i.place(x=10, y=5)
e_km_i = Entry(frame_baixo, width=22, justify='left', relief='solid')
e_km_i.place(x=15, y=30)
# Total Ganhos
l_km_i = Label(frame_baixo, text='Ganhos', anchor=NW, font=('Ivy 10 bold'), bg=cor7, fg=cor4, relief='flat')
l_km_i.place(x=160, y=5)
e_km_i = Entry(frame_baixo, width=22, justify='left', relief='solid')
e_km_i.place(x=165, y=30)
# Total Gastos
l_email = Label(frame_baixo, text='Gastos', anchor=NW, font=('Ivy 10 bold'), bg=cor7, fg=cor4, relief='flat')
l_email.place(x=10, y=55)
e_email = Entry(frame_baixo, width=22, justify='left', relief='solid')
e_email.place(x=15, y=80)
# Saldo
l_km_m = Label(frame_baixo, text='Saldo', anchor=NW, font=('Ivy 10 bold'), bg=cor7, fg=cor4, relief='flat')
l_km_m.place(x=160, y=55)
e_km_m = Entry(frame_baixo, width=22, justify='left', relief='solid')
e_km_m.place(x=165, y=80)

# Bt_Inserir
bt_inserir = Button(frame_baixo, text='Inserir', width=10, font=('Ivy 9 bold'), bg=cor6, fg=cor1, relief='raised', overrelief='ridge')
bt_inserir.place(x=10, y=115)
# Bt_Atualizar
bt_atualizar = Button(frame_baixo, text='Atualizar', width=10, font=('Ivy 9 bold'), bg=cor2, fg=cor1, relief='raised', overrelief='ridge')
bt_atualizar.place(x=105, y=115)
# Bt_Deletar
bt_deletar = Button(frame_baixo, text='Deletar', width=10, font=('Ivy 9 bold'), bg=cor7, fg=cor1, relief='raised', overrelief='ridge')
bt_deletar.place(x=200, y=115)

################ Codigo para tabela ####################

lista = [
    [1, 'Joao Futi Muanda', 'joao@mail.com', 123456789, "12/19/2010", 'Normal', 'gostaria de o consultar pessoalmente',1, 'Joao Futi Muanda', 'joao@mail.com', 123456789, "12/19/2010", 'Normal', 'gostaria de o consultar pessoalmente'],
...
tabela_head = ['ID', 'Data', 'Calculo', 'Km Inicial', 'Km Final', 'Km Morto', 'Km Rodado', 'Peso', 'Ent/Col', 'Dissel', 'Manutenção', 'Ganhos', 'Gastos', 'Saldo']
